...
export default function Translate() {
    return (
        <div className=" h-[80vh] overflow-y-auto">
            <h1 className="pt-10 text-center text-lg font-bold uppercase text-white">Переводчик</h1>
            <div className="translate_type">
                <p className="source_lang">Русский</p>
                <a href="" className="round_arrow_link"><img src="/images/rounded_arrow.svg" alt=""
                                                             className="round_arrow"/></a>
